...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent(null);
        pc.setEntity("cn.baas.rest.entity");
        pc.setMapper("cn.baas.rest.dao");
        pc.setXml("cn.baas.rest.dao.mapping");
        pc.setService("cn.baas.rest.service");        
        pc.setServiceImpl("cn.baas.rest.service.impl");    
        pc.setController("cn.baas.rest.controller");     
