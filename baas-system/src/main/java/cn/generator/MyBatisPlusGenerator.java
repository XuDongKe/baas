...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 自定义实体父类
     	...
     	// 自定义 controller 父类
     	strategy.setSuperControllerClass("cn.baas.common.base.BaseController");
        ...
        pc.setParent(null);
        pc.setEntity("cn.baas.modules.platform.entity");
        pc.setMapper("cn.baas.modules.platform.dao");
        pc.setXml("cn.baas.modules.platform.dao.mapping");
        pc.setService("cn.baas.modules.platform.service");        
        pc.setServiceImpl("cn.baas.modules.platform.service.impl");    
        pc.setController("cn.baas.modules.platform.controller");     
